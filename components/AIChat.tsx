      ...
      <div className="flex-grow overflow-y-auto pr-4 -mr-4 space-y-6">
        {messages.length === 0 && (
          <div className="text-center text-gray-500 dark:text-gray-400 pt-16">
            ...
            <h2 className="text-xl font-medium text-gray-700 dark:text-gray-300">AI Calculator Chat</h2>
        ...
        {messages.map((msg, index) => (
          <div key={index} className={`flex gap-3 ${msg.role === 'user' ? 'justify-end' : ''}`}>
            ...
            <div className={`p-3 rounded-lg max-w-md ${msg.role === 'user' ? 'bg-purple-600 text-white' : 'bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200'}`}>
        ...
        {isLoading && (
            <div className="flex gap-3">
                 ...
                 <div className="p-3 rounded-lg bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-200 flex items-center">
                    <div className="w-2 h-2 bg-gray-500 dark:bg-gray-400 rounded-full animate-pulse delay-75"></div>
                    <div className="w-2 h-2 bg-gray-500 dark:bg-gray-400 rounded-full animate-pulse delay-150 mx-1"></div>
      ...
      <form onSubmit={handleSendMessage} className="mt-6">
        <div className="relative">
          <input
            ...
            className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg py-3 pl-4 pr-12 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-shadow"
            disabled={isLoading}
          />
